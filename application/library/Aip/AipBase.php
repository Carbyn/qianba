...
class AipBase {
    ...
    protected $accessTokenUrlPro = 'https://openapi.baidu.com/oauth/2.0/token';
    ...
    private function getAuthFilePath(){
        return dirname(__FILE__) . DIRECTORY_SEPARATOR . md5($this->apiKey.$this->pro);
    }
    ...
    private function auth($refresh=false){
        ...
        $realUrl = $this->pro ? $this->accessTokenUrlPro : $this->accessTokenUrl;
        $response = $this->client->get($realUrl, array(
